...
public class Les4{
  ...
  { //hier start de "body" van de function
    ...
    // Verplaatst naar functie playSound();
  ...
  private void playSound(String file) {
    try{
      URL url = (URL) this.getClass().getResource("sound/"+file);
